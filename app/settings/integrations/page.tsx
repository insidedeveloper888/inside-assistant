...
export default function IntegrationsPage() {
  ...
  async function disconnectWa() {
    if (!confirm("Disconnect WhatsApp? AI replies will stop working until you re-scan.")) return;
    setWaLoading(true);
          ...
          <div className="mb-4 flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-500">
                Connect the team&apos;s WhatsApp number. Whitelisted team members messaging this number get AI replies.
              </p>
            </div>
            {wa?.status === "connected" && (
            ...
            <div className="space-y-3">
              ...
              {wa.qrCode ? (
                ...
                <div className="space-y-2">
                  <p className="text-xs text-amber-400">QR code not available. Try again.</p>
